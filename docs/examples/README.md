...
The example records intentionally live outside the real `File Metadata/` record tree. They use fixed sample UUIDs and placeholder PDF links and must not be treated as production records.
